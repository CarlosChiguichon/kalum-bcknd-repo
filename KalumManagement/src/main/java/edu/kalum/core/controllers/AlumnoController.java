...
public class AlumnoController {
    ...
    public ResponseEntity<?> listarAlumnos(){
        ...
        try {
            ...
            if (alumnos == null && alumnos.isEmpty()) {
                ...
                logger.info("Se consulto la informacion de alumnos");
    ...
    public ResponseEntity<?> showAlumno(@PathVariable String carne){
        Map<String,Object> response = new HashMap();
        logger.debug("Iniciando la busqueda de alumno con carne #".concat(carne));
        try {
            Alumno alumno = alumnoService.findById(carne);
            if (alumno == null) {
                logger.warn("No existe el alumno con carne #".concat(carne));
                response.put("Mensaje","No existe el alumno con el carne #".concat(carne));
                return new ResponseEntity<Map<String,Object>>(response,HttpStatus.NOT_FOUND);
            } else {
                logger.info("Se proceso la busqueda del alumno de forma exitosa");
